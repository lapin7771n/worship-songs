...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "Are you sure you want to delete this lyrics? If deleted, lyrics will no longer be available to all users." : MessageLookupByLibrary.simpleMessage("Are you sure you want to delete these lyrics? If deleted, lyrics will no longer be available to all users."),
    ...
    "Delete Photo" : MessageLookupByLibrary.simpleMessage("Delete Image"),
    ...
    "Find the lyrics of popular christian songs to sing with people you love" : MessageLookupByLibrary.simpleMessage("Find the lyrics of popular Сhristian songs to sing with people you love"),
    ...
    "It’s really save!" : MessageLookupByLibrary.simpleMessage("It’s really safe!"),
    ...
    "No more passwords to forgot" : MessageLookupByLibrary.simpleMessage("No more passwords to forget"),
    ...
    "Select new photo from gallery" : MessageLookupByLibrary.simpleMessage("Select new Image from gallery"),
    ...
    "To add chords to the lyrics insert “.”(Dot Sign) at start of Chords String" : MessageLookupByLibrary.simpleMessage("To add chords to the lyrics insert “.”(Dot Sign) at the start of Chords String"),
